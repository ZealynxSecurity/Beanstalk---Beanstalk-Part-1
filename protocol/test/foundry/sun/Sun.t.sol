...
//   function testCalcCaseIdAndUpdate() public {
//     // Preparación de valores iniciales
//     int256 deltaB = 1000; // Ejemplo de deltaB
//     uint256 temperatura= weather.getTemperature(); // Configura una temperatura inicial
//     uint256 ratio = weather.getBeanToMaxLpGpPerBdvRatio(); // Configura un ratio inicial

//     // Llamada a la función bajo prueba
//     weather.calcCaseIdandUpdate(deltaB);

//     // Obtención de valores actualizados
//     uint256 updatedTemperature = weather.getTemperature();
//     uint256 updatedRatio = weather.getBeanToMaxLpGpPerBdvRatio();

//     // Aserciones para verificar las invariantes
//     assert(updatedTemperature != temperatura);
//     assert(updatedRatio != ratio);
// }
